# Dokumentasi Neurogaze

- [`bukti_gate_a_b.md`](bukti_gate_a_b.md): hasil kanonis, kriteria lulus, dan batas klaim Gate A/B.
- [`protokol_gate_validasi.md`](protokol_gate_validasi.md): definisi Gate A–D dan status saat ini.
