...
Cetak satu lembar. Jangan dibaca — dilirik.
...
| | |
|---|---|
| Tab 1 | `/perbandingan` — **sudah terbuka**, sudah di-scroll ke tabel |
| Tab 2 | Beranda → `Panduan & demo`, **sudah di-scroll** ke kotak peragaan |
| Tab 3 | Laporan penjaga OOD, **sudah terbuka** di panel riset |
| Deck | Slide 1 |
| Tablet | Terisi penuh, mode pesawat **mati** hanya kalau perlu, kecerahan maksimal |
| Kamera | Sudah diuji di ruangan itu, dengan cahaya ruangan itu |
| Cetakan | [`daftar_klaim.md`](daftar_klaim.md), satu per juri |

Tiga tab, sudah terbuka, sudah di posisi. Mencari halaman di atas panggung memakan dua
puluh detik dan setiap detiknya terlihat.

---

## Jalannya

| Menit | Layar | Yang dilakukan | Jangan |
|---|---|---|---|
...
2. *"Yang menyala adalah simulasi pola rujukan, bukan rujukan."* — sesudah demo
3. *"Wajahnya terlihat, tapi arah pandangan belum cukup jelas. Sampel detik ini
   **ditolak, bukan ditebak**."* — saat cermin panggung menunjukkannya
...
| Jangan | Pakai |
|---|---|
| "Usia diagnosis di Indonesia 56 bulan" | "Tinjauan lintas negara melaporkan sekitar 56 bulan" |
| "Kami berpura-pura autis" | "Saya memproduksi pola yang literatur identifikasi sebagai penanda dini" |
| "Sensitivitas kami 67 persen" | "Empat dari enam sesi pola diproduksi memicu aturan demonstrasi" |
...
Sebut penyebab yang terlihat, **satu kali**, lalu pindah. Jangan menekan tombol berulang.

> "Demo langsung tertahan gerbang mutu. Itu hasil yang sah — sistem menolak membuat angka
> ketika inputnya tidak layak, dan separuh sesi pola diproduksi kami memang gugur di sana."

Lalu kembali ke Tab 1. Layar perbandingan sudah membawa seluruh klaimnya tanpa kamera,
dan itu sebabnya ia dijalankan lebih dulu.
...
|---|---|
| "Jadi ini sudah merujuk balita?" | "Belum. Klip 16,75 detik tidak mereplikasi protokol tempat ambang 69% diterbitkan." |
| "544 dari 547 kan hampir pasti tinggi?" | "Betul, dan kami menyebutnya sendiri di slide — referensinya dikalibrasi di persentil 99,5." |
