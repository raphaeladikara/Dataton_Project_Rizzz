...
const DESIGN_CHOICES = [
  ...
  ["Pupil gelap di atas sklera terang", "Wajah skematik memicu gaze following, tetapi efeknya dibawa oleh polaritas kontras mata yang lazim: pupil gelap pada sklera terang. Isyarat berpolaritas terbalik menghasilkan efek yang jauh lebih lemah, jadi warna ini bukan pilihan gaya. Sklera #fffdf7 lawan pupil #16181b, dan kontrasnya dijaga uji kontrak agar penataan ulang visual tidak dapat mencabutnya."],
  ["Mata benar-benar bergerak, bukan digambar sudah menyamping", "Yang menjadi isyarat adalah gerak pupil yang terlihat. Bola mata bergeser 16 piksel pada onset dengan transisi 240 ms berjeda 50 ms, sehingga mata berangkat lebih dulu daripada kepala dan tangan seperti pada isyarat manusia."],
  ["Ostensif dulu, arah kemudian", "Bayi mengikuti tatapan ketika didahului kontak mata atau sapaan, dan tidak ketika didahului animasi non-sosial yang sekadar menarik perhatian. Karena itu setiap percobaan membuka dengan kepala terangkat, kontak mata, dan senyum sebelum ada satu pun informasi arah."],
